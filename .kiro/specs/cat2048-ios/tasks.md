...
- [ ] 3. 实现 GameViewModel 核心逻辑
  - [ ] 3.1 实现 `GameViewModel.swift` 基础结构与状态属性
  ...
  - [ ] 3.5 实现 `addRandomTile`、`startNewGame` 与初始化
  ...
  - [ ] 3.7 实现 `canMove`、`checkWin`、`checkGameOver`
...
- [ ] 5. 实现排行榜逻辑
  - [ ] 5.1 在 `GameViewModel` 中实现排行榜更新方法
